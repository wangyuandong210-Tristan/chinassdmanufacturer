...
(function() {
  ...
  var t = {
    en: {
      ...
      ind_sol_desc:"Our SSDs and memory modules power applications in 50+ countries across key sectors",
      ind_gaming:"Gaming",ind_gaming_d:"High-speed NVMe SSDs for gaming PCs and consoles",
      ind_ipc:"Industrial PC",ind_ipc_d:"Wide-temperature SSDs for embedded/industrial systems",
      ind_medical:"Medical",ind_medical_d:"Reliable storage for medical devices",
      ind_ai:"AI & Edge Computing",ind_ai_d:"High-endurance SSDs for AI inference and edge servers",
      ind_surveillance:"Surveillance",ind_surveillance_d:"High-TBW SSDs for NVR storage",
      ind_server:"Server & Data Center",ind_server_d:"Enterprise eSSD for data center/cloud",
      mfg_smt:"SMT Assembly",mfg_smt_d:"6 automated SMT lines. 50,000+ daily capacity.",
      mfg_burnin:"Aging & Burn-in",mfg_burnin_d:"24-72 hour burn-in at elevated temp. 100% tested.",
      mfg_qa:"QA Laboratory",mfg_qa_d:"In-house QC lab with thermal and signal testing.",
      mfg_line:"Production Line",mfg_line_d:"End-to-end production. 200+ trained operators.",
      mfg_wh:"Warehouse & Logistics",mfg_wh_d:"Temp-controlled NAND storage. Global shipping.",
      mfg_capacity:"Production Capacity",mfg_capacity_d:"10M+ units annual capacity across all lines.",
      mfg_cta:"Take a Factory Tour",
      adv_mfg:"Manufacturing",adv_mfg_d:"10,000m2 with 6 SMT lines. 10M+ annual capacity.",
      adv_rd:"R&D Capability",adv_rd_d:"In-house R&D team. Firmware, PCB, product design.",
      adv_supply:"Stable Supply Chain",adv_supply_d:"Branded NAND from Samsung, Kioxia, YMTC.",
      adv_qc:"Quality Control",adv_qc_d:"100% burn-in test. ISO 9001. CE/FCC/ROHS/REACH.",
      adv_custom:"Flexible Customization",adv_custom_d:"Custom branding, packaging, firmware. MOQ 200.",
      adv_global:"Global Delivery",adv_global_d:"DHL/FedEx/sea freight to 50+ countries.",
      cat_consumer:"Consumer SSD",cat_consumer_d:"NVMe PCIe 4.0 & SATA III. 256GB-2TB.",
      cat_enterprise_d:"Data center grade. 512GB-8TB.",
      cat_ddr5_d:"4800-7200MHz. 8GB-32GB per module.",
      cat_ddr4_d:"2666-3600MHz. 4GB-32GB per module.",
      cat_odm2:"OEM/ODM Services",cat_odm2_d:"Custom branding, firmware, packaging.",
      hero_stat_yr:"Years in Industry",hero_stat_fa:"Factory Area",
    },

      adv_sub:"13+ years of manufacturing expertise serving global B2B clients",
      mfg_sub:"10,000m2 Factory, Fully Equipped",
      mfg_desc:"Our Shenzhen facility operates at scale with strict quality control at every stage",
      cat_ddr4_d:"2666-3600MHz. 4GB-32GB per module.",
      cat_ddr5_d:"4800-7200MHz. 8GB-32GB per module.",
      cat_industrial_d:"Wide-temperature, high-TBW. 32GB-512GB.",
      cat_odm2:"OEM/ODM Services",cat_odm2_d:"Custom branding, firmware, packaging.",
      cert_ce:"CE",cert_fcc:"FCC",cert_rohs:"ROHS",cert_iso:"ISO 9001",
      cert_reach:"REACH",cert_ukca:"UKCA",cert_t2:"Quality & Compliance Certifications",
      footer_prod1:"NVMe SSD",footer_prod2:"SATA SSD",
      stat2:"50M+",stat2_l:"SSDs Manufactured",stat3:"500+",stat3_l:"Active B2B Clients",
    zh: {
